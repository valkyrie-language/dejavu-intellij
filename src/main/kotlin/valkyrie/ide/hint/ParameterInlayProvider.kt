...
class ParameterInlayProvider : InlayParameterHintsProvider {
    ...
    override fun getSupportedOptions(): MutableList<Option> {
        return mutableListOf(
            Option("getSupportedOptions1", NexusBundle.messagePointer("color.token.null"), true),
            Option("getSupportedOptions2", NexusBundle.messagePointer("color.token.boolean"), true)
        )
    }
}
