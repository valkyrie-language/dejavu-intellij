...
open class ConcreteElement : ASTNode {
    protected val _text: CharSequence
    protected val _span: TextRange
    protected val _parent: ASTNode? = null
    protected val _children: MutableList<ASTNode> = mutableListOf()
    protected val _token_type: IElementType
