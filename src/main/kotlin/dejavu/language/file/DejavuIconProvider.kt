...
class DejavuIconProvider : IconProvider() {
...
//            }
    ...
    object Instance {
        val Valkyrie = IconLoader.getIcon("/icons/vk.svg", DejavuIconProvider::class.java)

        //
        val NAMESPACE = AllIcons.Nodes.Artifact
        val SNIPPET = AllIcons.Actions.MoreHorizontal
        val Operator = IconLoader.getIcon("/icons/operator.svg", DejavuIconProvider::class.java)
