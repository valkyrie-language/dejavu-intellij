...
// export/import
ie_template:   TEMPLATE_L (define_import | define_export)+ TEMPLATE_R;
...
dot_call
    : DOT identifier
    | DOT identifier PARENTHESES_L (call_term (COMMA call_term)* COMMA?)? PARENTHESES_R
    ;
call_term: (identifier COLON)? expression;
// === modifiers === ===================================================================================================
