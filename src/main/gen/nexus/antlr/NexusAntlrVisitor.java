...
public interface NexusAntlrVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#apply_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitApply_statement(NexusAntlrParser.Apply_statementContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#apply_begin}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitApply_begin(NexusAntlrParser.Apply_beginContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#apply_end}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitApply_end(NexusAntlrParser.Apply_endContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#match_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_statement(NexusAntlrParser.Match_statementContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#match_begin}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_begin(NexusAntlrParser.Match_beginContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#case_branch}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCase_branch(NexusAntlrParser.Case_branchContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#match_end}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_end(NexusAntlrParser.Match_endContext ctx);
	/**
	 * Visit a parse tree produced by {@link NexusAntlrParser#any_expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAny_expression(NexusAntlrParser.Any_expressionContext ctx);
	/**
