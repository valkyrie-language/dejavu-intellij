...
public class DejavuEachTemplateNode extends DejavuElement implements DejavuEachTemplate {

    public DejavuEachTemplateNode(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull DejavuVisitor visitor) {
        visitor.visitEachTemplate(this);
    }
