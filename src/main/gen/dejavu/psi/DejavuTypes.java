...
public interface DejavuTypes {
  ...
  IElementType DOT_CALL = new DejavuElementType("DOT_CALL");
    IElementType EACH_ELEMENT = new DejavuElementType("EACH_ELEMENT");
    IElementType EACH_STATEMENT = new DejavuElementType("EACH_STATEMENT");
    IElementType EACH_TEMPLATE = new DejavuElementType("EACH_TEMPLATE");
    ...
    IElementType UNTIL_ELEMENT = new DejavuElementType("UNTIL_ELEMENT");
    IElementType UNTIL_STATEMENT = new DejavuElementType("UNTIL_STATEMENT");
    IElementType UNTIL_TEMPLATE = new DejavuElementType("UNTIL_TEMPLATE");
    ...
    IElementType WHILE_TEMPLATE = new DejavuElementType("WHILE_TEMPLATE");
    ...
    IElementType KW_UNTIL = new DejavuTokenType("KW_UNTIL");
    ...
    class Factory {
        public static PsiElement createElement(ASTNode node) {
            ...
            } else if (type == EACH_ELEMENT) {
                return new DejavuEachElementNode(node);
            } else if (type == EACH_STATEMENT) {
                return new DejavuEachStatementNode(node);
            } else if (type == EACH_TEMPLATE) {
                return new DejavuEachTemplateNode(node);
            ...
            } else if (type == UNTIL_ELEMENT) {
                return new DejavuUntilElementNode(node);
            } else if (type == UNTIL_STATEMENT) {
                return new DejavuUntilStatementNode(node);
            } else if (type == UNTIL_TEMPLATE) {
                return new DejavuUntilTemplateNode(node);
            ...
            } else if (type == WHILE_TEMPLATE) {
                return new DejavuWhileTemplateNode(node);
            }
