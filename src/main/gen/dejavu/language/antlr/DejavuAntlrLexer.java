...
public class DejavuAntlrLexer extends Lexer {
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "DOT", "COMMA", "KW_EXPORT", "KW_IMPORT", "KW_AS", "KW_IN", "KW_IF",
                "KW_ELSE", "KW_END", "KW_FOR", "KW_MATCH", "KW_CASE", "KW_WITH", "KW_SLOT",
                "KW_APPLY", "KW_BREAK", "KW_CONTINUE", "OP_PROPORTION", "PARENTHESES_L",
                "PARENTHESES_R", "BRACKET_L", "BRACKET_R", "BRACE_L", "BRACE_R", "GENERIC_L",
                "GENERIC_R", "RAW_ID", "UNICODE_ID", "SPACE_CONTROL", "WHITE_SPACE",
